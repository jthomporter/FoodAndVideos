...
<?php
  echo '<div id="logo" class="LogoRow" ' . 'onclick="location.href=' . "'home.html'" . '">';
  echo  '<img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsweetdrawingblog%2FSweet-Drawing-Blog%2Fwp-content%2Fuploads%2F2015%2F01%2F24225827%2FRounded-Rectangle1.png&f=1&nofb=1" alt="pic" />';
  echo '</div>';
